/**
 * CCOS Course Player Event Handler
 * Manages communication between Thinkific Course Player and lesson content in Multimedia Pages
 * This Javascript is loaded into the parent window of the lesson content iframe    
 * Visit: https://www.superpowerups.com/pages/install-ccos-course-player-manager to add this script to your site
 */

class CCOSCoursePlayerManager {
    constructor() {
    ...
    navigateLink(options = {}) {
        ...
        console.log('Link clicked in iframe:', config);
        if (config.opensInNewWindow) {
            // Open in new window/tab
            //console.log('Link will open in new window/tab');
            window.open(config.url, '_blank');
        } else {
            // Navigate the parent window or iframe as desired
            //console.log('Link will open in same window');
...
window.ccosCoursePlayerManager = new CCOSCoursePlayerManager();
